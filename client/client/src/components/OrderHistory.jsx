          ...
          {completedOrders.length === 0 ? (
            ...
            >
              ...
              <p style={{ color: 'var(--gray)' }}>
                У вас пока нет оформленных заказов. Вернитесь на главную
                страницу, чтобы найти товары.
              </p>
            </div>
          ) : (
            <div
          ...
          {completedOrders.length > 0 && (
            ...
            >
              ...
              >
                ...
                ></i>
                Все: {completedOrders.length} завершенный заказ
              </h3>
              <p
                style={{
                  color: 'var(--gray)',
              ...
              >
                Общее сумма выполненных заказов:{' '}
